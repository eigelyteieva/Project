...
void paskirstymo_isve(list<duomenys> vargsiukai, list<duomenys> kietekai)
{
    ...
    for (int i=0; i<vargsiukai.size(); i++)
    {
        ...
        duom_maz5<<setw(20)<<std::left<<s->vardas<<setw(20)<<std::left<<s->pavarde<<setw(20)<<std::setprecision(2)<<std::left<<s->galutinis_egz<<endl;
    }
    duom_maz5.close();
    ...
    for (int i=0; i<kietekai.size(); i++)
    {
        ...
        duom_daug5<<setw(20)<<std::left<<s->vardas<<setw(20)<<std::left<<s->pavarde <<setw(20)<<std::setprecision(2)<<std::left<<s->galutinis_egz<<endl;
    }
    duom_daug5.close();
}
