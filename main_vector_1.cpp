...
void paskirstymo_isve(vector<duomenys> vargsiukai, vector<duomenys> kietekai)
{
    ...
    {
        duom_maz5<<setw(20)<<std::left<<vargsiukai[i].vardas<<setw(20)<<std::left<<vargsiukai[i].pavarde<<setw(20)<<std::setprecision(2)<<std::left<<vargsiukai[i].galutinis_egz<<endl;
    }
    duom_maz5.close();
    for (auto i=0; i<kietekai.size(); i++)
    {
        duom_daug5<<setw(20)<<std::left<<kietekai[i].vardas<<setw(20)<<std::left<<kietekai[i].pavarde <<setw(20)<<std::setprecision(2)<<std::left<<kietekai[i].galutinis_egz<<endl;
    }
    duom_daug5.close();
}
